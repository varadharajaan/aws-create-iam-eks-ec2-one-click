...
class AWSDefaultVPCChecker:
    def __init__(self, config_file='aws_accounts_config_bk.json'):
    ...
    def validate_subnet_distribution(self, subnet_details, region):
        ...
        if subnet_count > rules['max_subnets']:
            return False, f"Excess subnets: {subnet_count} > {rules['max_subnets']} (maximum)"
    ...
    def save_results_to_file(self, results):
        ...
        try:
            ...
            filename = f"aws_default_vpc_check_report_{timestamp}.json"
